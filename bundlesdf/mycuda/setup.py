...
#c_flags = ['-O3', '-std=c++14']
#nvcc_flags = ['-Xcompiler', '-O3', '-std=c++17', '-U__CUDA_NO_HALF_OPERATORS__', '-U__CUDA_NO_HALF_CONVERSIONS__', '-U__CUDA_NO_HALF2_OPERATORS__', '-gencode=arch=compute_86,code=sm_86']
c_flags = ['-O3', '-std=c++17']
setup(
    name='common',
